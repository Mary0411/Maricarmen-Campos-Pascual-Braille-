 ...
 * @author WARY
 */
public class braileCodigo implements IBrailee {
    ...
    public void imprimirPdf() {
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream("syui.pdf"));
            doc.open();
            ...
            int x = 25;
            int y = 600;
            String url = "C:\\Users\\WARY\\Documents\\NetBeansProjects\\BrailePrueba1\\Img\\";
            String ect = "";
            ...
            Logger.getLogger(BrailePrueba1.class.getName()).log(Level.SEVERE, null, ss);
        }
    }
}
